...
import com.objectforge.mascot.examples.DinersCanvas;
...
public class DinersDisplay extends AbstractRoot {
	...
	public JButton resume = new JButton();
	public JSlider slider = new JSlider(10, 6000, 5000);
	boolean pause = false;
