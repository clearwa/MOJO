...
public class CommandLineInterfaceFactory implements InterfaceFactory
{
	...
	{
		commandLineInterfaceConstructor = commandLineInterfaceClass.getConstructor( new Class[] { TelnetConnection.class } );
	}
	...
	public void connect( TelnetConnection telnet )
	{
		try
		{
			commandLineInterfaceConstructor.newInstance( new Object[] { telnet } );
		}
